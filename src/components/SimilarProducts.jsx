...
const SimilarProducts = () => {
  ...
  return (
    <section className='min-h-96 mx-auto mt-[16%] w-screen max-w-6xl pb-[5%] landscape:lg:mt-[14%] landscape:4xl:mt-[10%] landscape:5xl:mt-[9%] 6xl:mt-[3%] portrait:md:mt-16 portrait:mt-56 portrait:xs:mt-20'>
