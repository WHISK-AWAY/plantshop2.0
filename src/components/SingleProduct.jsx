            ...
            <div className='mx-8 md:mx-0 md:w-1/3'>
              ...
              <div className=' mb-3 md:border-b-4 md:pb-4'>
                <button
                  ...
                  className='btn mx-auto block w-full transition-all duration-700 hover:scale-[1.04] bg-green-gray py-2 font-light font-outfit text-[3.8vw] text-white md:text-[2vw] 4xl:text-[1.5vw] 5xl:text-[1.2vw] '
                >
