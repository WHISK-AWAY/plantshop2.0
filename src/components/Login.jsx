        ...
        <section className=' flex flex-col items-center justify-center  portrait:gap-2 landscape:gap-2'>
          <form onSubmit={onSubmit} className=''>
            ...
            <div className='flex items-center justify-between'>
              <button
                type='submit'
                className='btn mx-auto block w-full  py-2 text-[4vw] text-white duration-500 hover:transition-all md:text-[2.6vw] landscape:lg:py-2 landscape:lg:text-[1.7vw] landscape:xl:text-[1.1rem]  landscape:2xl:text-[1rem] landscape:3xl:py-1 landscape:3xl:text-[1.1rem] landscape:4xl:text-[1.2rem] landscape:5xl:text-[1.1vw] landscape:6xl:text-[1vw]  landscape:text-[1rem] landscape:pt-2 landscape:lg:pt-1 portrait:lg:pt-1 portrait:lg:text-[1.4rem]  '
              >
