      ...
      <>
        ...
        <div className='relative  xl:pt-28 5xl:pt-44 6xl:pt-56'>
          <div className="absolute top-0 left-0 h-screen w-screen overflow-hidden bg-[url('/assets/bg_img/admin.webp')] bg-cover bg-fixed bg-bottom bg-no-repeat pt-3  font-outfit   portrait:w-full portrait:px-2 landscape:lg:pt-20 ">
            ...
            <div className='mx-auto max-h-[70vh] portrait:h-[80svh] landscape:2xl:max-h-[80dvh] landscape:h-[65svh] landscape:4xl:h-[75dvh] landscape:5xl:h-[65dvh] landscape:short:h-[65svh] landscape:xl:h-[80dvh] landscape:2xl:h-[70dvh] w-fit max-w-[1200px] overflow-y-auto border border-green-gray bg-white/80 p-2 md:min-w-[700px] lg:text-[2.8vw] 4xl:min-w-[900px] 5xl:max-h-[65vh] 5xl:min-w-[900px]  portrait:w-[90vw] portrait:border-green-gray portrait:xxs:w-[96vw] portrait:xs:min-h-[78vh] portrait:xs:max-w-[90vw] portrait:md:min-h-[75vh] portrait:lg:h-[90vh] landscape:w-[90svw]'>
